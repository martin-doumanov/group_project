...
```
We can see that there are 68 different property types. The top 4 most common property types are entire rental units (48.0%), private rooms in rental units (35.7%), entire condos (2.7%) & entire serviced apartments (2.0%), which totals 88.4% of the data.
